...
//Index Slider
new Swiper('.index_swiper', (_Swiper = {
  // Optional parameters
  loop: true,
  preloadImages: false,
  lazy: false,
...
}), _defineProperty(_Swiper2, "renderBullet", function renderBullet(index, className) {
...
//Reasons Slider
new Swiper('.reasons_swiper', (_Swiper3 = {
  // Optional parameters
  loop: false,
  preloadImages: false,
  lazy: false,
  modules: [Pagination, Lazy]
}, _defineProperty(_Swiper3, "lazy", {
  loadPrevNext: false
}), _defineProperty(_Swiper3, "pagination", {
  el: ".swiper-pagination",
  clickable: true,
...
window.addEventListener('click', function () {
  var button = document.getElementById('#detail_oc');
